 ...
 */
public class CitationListAdapter extends ArrayAdapter<CitationItem> implements View.OnClickListener/*, View.OnTouchListener*/{
    ...
    public CitationListAdapter(Context context, int resLayout, List<CitationItem> listCitationItems) {
    ...
    /** constructeur de l'adapter  */
    public CitationListAdapter(Context context, int resLayout, List<CitationItem> listCitationItems, ListView lvCitation) {
        super(context, resLayout, listCitationItems);
    ...
    public static void information_auteur(Context context, String url_auteur){
        ...
        Intent intent = new Intent(context, com.citation.emmanuel.citation365.Auteur.class);
        ...
        public boolean onTouch(View v, MotionEvent event) {
            switch (event.getAction()) {
                ...
                case MotionEvent.ACTION_CANCEL: {
                    ...
                    if ((deltaX) >= MIN_DISTANCE_X/2 &&  Math.abs(deltaY) <= MIN_DISTANCE_Y ) {
